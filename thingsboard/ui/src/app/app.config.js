...
const PRIMARY_BACKGROUND_COLOR ="#263238";//"#305680";//#2856b6";//"#3f51b5";
const SECONDARY_BACKGROUND_COLOR = "#37474f"; // "#527dad";
const HUE3_COLOR ="#cfd8dc";  //"#a7c1de";
...
/*            var rootScope = $injector.get("$rootScope");
    ...
    function indigoTheme() {
        ...
        var tbAccentPalette = $mdThemingProvider.extendPalette('indigo', {
            'A700' : "#304FFE"
        }); //deep-orange
